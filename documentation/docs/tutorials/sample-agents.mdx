...
Most samples are **Platform-Hosted**, meaning you point the Agent Manager at the sample's directory and it builds and runs the agent for you. Follow [Create Your First Agent](./create-your-first-agent.mdx) and set **App Path** to the path given below for each sample. Two samples run on your own machine as **Externally-Hosted** agents instead, and say so.
...
| Topic | Guide |
|---|---|
| Deploy one of these into your own environment | [Create Your First Agent](./create-your-first-agent.mdx) |
| See the traces a sample produces | [Observe Your First Agent](./observe-first-agent.mdx) |
